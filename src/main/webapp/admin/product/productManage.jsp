...
<div class="col-lg-8">
	...
	<form id="productSearch">	
		<div class="form-row justify-content-center">	
			...
			<div class="col-2">
			    <input type="button" id="productSearchBtn" class="form-control btn btn-outline-dark" value="검색">		
			</div>
		</div>				
	</form>	
</div>
...
<script type="text/javascript" src="/minishop/resources/custom/js/adminProduct/productManage.js"></script>
